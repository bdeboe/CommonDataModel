--InterSystems IRIS CDM DDL Specification for OMOP Common Data Model 5.4
...
CREATE TABLE @cdmDatabaseSchema.PERSON (
			...
			person_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
			gender_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
			gender_source_concept_id integer NULL,
			race_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
			race_source_concept_id integer NULL,
			ethnicity_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
...
CREATE TABLE @cdmDatabaseSchema.VISIT_OCCURRENCE (
			...
			provider_id integer NULL,
			care_site_id integer NULL,
			visit_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
			visit_source_concept_id integer NULL,
			admitted_from_concept_id integer NULL,
			admitted_from_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
			discharged_to_concept_id integer NULL,
			discharged_to_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
...
CREATE TABLE @cdmDatabaseSchema.VISIT_DETAIL (
			...
			provider_id integer NULL,
			care_site_id integer NULL,
			visit_detail_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
...
CREATE TABLE @cdmDatabaseSchema.CONDITION_OCCURRENCE (
			...
			stop_reason varchar(20) NULL WITH STORAGETYPE = COLUMNAR,
			provider_id integer NULL,
			visit_occurrence_id integer NULL,
			visit_detail_id integer NULL,
			condition_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
...
CREATE TABLE @cdmDatabaseSchema.DRUG_EXPOSURE (
			...
			lot_number varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
			provider_id integer NULL,
			visit_occurrence_id integer NULL,
			visit_detail_id integer NULL,
			drug_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
			drug_source_concept_id integer NULL,
			route_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
...
CREATE TABLE @cdmDatabaseSchema.PROCEDURE_OCCURRENCE (
			...
			visit_occurrence_id integer NULL,
			visit_detail_id integer NULL,
			procedure_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
...
CREATE TABLE @cdmDatabaseSchema.DEVICE_EXPOSURE (
			...
			unique_device_id varchar(255) NULL WITH STORAGETYPE = COLUMNAR,
			production_id varchar(255) NULL WITH STORAGETYPE = COLUMNAR,
			quantity integer NULL,
			provider_id integer NULL,
			visit_occurrence_id integer NULL,
			visit_detail_id integer NULL,
			device_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
			device_source_concept_id integer NULL,
			unit_concept_id integer NULL,
			unit_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
...
CREATE TABLE @cdmDatabaseSchema.MEASUREMENT (
			...
			measurement_time varchar(10) NULL WITH STORAGETYPE = COLUMNAR,
			...
			visit_occurrence_id integer NULL,
			visit_detail_id integer NULL,
			measurement_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
			measurement_source_concept_id integer NULL,
			unit_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
			unit_source_concept_id integer NULL,
			value_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
...
CREATE TABLE @cdmDatabaseSchema.OBSERVATION (
			...
			value_as_number NUMERIC NULL,
			value_as_string varchar(60) NULL WITH STORAGETYPE = COLUMNAR,
			value_as_concept_id Integer NULL,
			...
			visit_occurrence_id integer NULL,
			visit_detail_id integer NULL,
			observation_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
			observation_source_concept_id integer NULL,
			unit_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
			qualifier_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
			value_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
...
CREATE TABLE @cdmDatabaseSchema.DEATH (
			...
			cause_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
...
CREATE TABLE @cdmDatabaseSchema.NOTE (
			...
			note_title varchar(250) NULL WITH STORAGETYPE = COLUMNAR,
			...
			visit_occurrence_id integer NULL,
			visit_detail_id integer NULL,
			note_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
...
CREATE TABLE @cdmDatabaseSchema.NOTE_NLP (
			...
			snippet varchar(250) NULL WITH STORAGETYPE = COLUMNAR,
			"offset" varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
			lexical_variant varchar(250) NOT NULL WITH STORAGETYPE = COLUMNAR,
			note_nlp_concept_id integer NULL,
			note_nlp_source_concept_id integer NULL,
			nlp_system varchar(250) NULL WITH STORAGETYPE = COLUMNAR,
			nlp_date date NOT NULL,
			nlp_datetime TIMESTAMP NULL,
			term_exists varchar(1) NULL WITH STORAGETYPE = COLUMNAR,
			term_temporal varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
...
CREATE TABLE @cdmDatabaseSchema.SPECIMEN (
			...
			specimen_source_id varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
			specimen_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
			unit_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
			anatomic_site_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
...
CREATE TABLE @cdmDatabaseSchema.LOCATION (
			...
			address_1 varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
			address_2 varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
			city varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
			state varchar(2) NULL WITH STORAGETYPE = COLUMNAR,
			zip varchar(9) NULL WITH STORAGETYPE = COLUMNAR,
			county varchar(20) NULL WITH STORAGETYPE = COLUMNAR,
			location_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
			country_concept_id integer NULL,
			country_source_value varchar(80) NULL WITH STORAGETYPE = COLUMNAR,
...
CREATE TABLE @cdmDatabaseSchema.CARE_SITE (
			...
			care_site_name varchar(255) NULL WITH STORAGETYPE = COLUMNAR,
			place_of_service_concept_id integer NULL,
			location_id integer NULL,
			care_site_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
...
CREATE TABLE @cdmDatabaseSchema.PROVIDER (
			...
			provider_name varchar(255) NULL WITH STORAGETYPE = COLUMNAR,
			npi varchar(20) NULL WITH STORAGETYPE = COLUMNAR,
			dea varchar(20) NULL WITH STORAGETYPE = COLUMNAR,
			specialty_concept_id integer NULL,
			care_site_id integer NULL,
			year_of_birth integer NULL,
			gender_concept_id integer NULL,
			provider_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
			specialty_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
...
CREATE TABLE @cdmDatabaseSchema.PAYER_PLAN_PERIOD (
			...
			payer_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
			payer_source_concept_id integer NULL,
			plan_concept_id integer NULL,
			plan_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
			plan_source_concept_id integer NULL,
			sponsor_concept_id integer NULL,
			sponsor_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
			sponsor_source_concept_id integer NULL,
			family_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
			stop_reason_concept_id integer NULL,
			stop_reason_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
...
CREATE TABLE @cdmDatabaseSchema.COST (
			...
			cost_domain_id varchar(20) NOT NULL WITH STORAGETYPE = COLUMNAR,
			...
			revenue_code_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
...
CREATE TABLE @cdmDatabaseSchema.EPISODE (
			...
			episode_source_value varchar(50) NULL WITH STORAGETYPE = COLUMNAR,
